...
public class PageAddressAccount {

    private List<AddressReportDto> content;
    ...
    // Getters e Setters
    public List<AddressReportDto> getContent() {
        return content;
    }

    public void setContent(List<AddressReportDto> content) {
